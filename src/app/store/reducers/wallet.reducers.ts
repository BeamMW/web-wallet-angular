...
export interface WalletState extends EntityState<Address> {
...
export const initialState: WalletState = adapter.getInitialState({
...
export function walletReducer(state = initialState, action: Action): WalletState {
